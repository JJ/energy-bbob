...
<<evostar.bbob.compares, echo=F, message=F, warning=F, fig.height=5, fig.show="hold", fig.cap="PKG energy consumed in every experiment evaluating 40K chromosomes with 128 dimensions, using arrays or vectors. Please note the $y$ axes have different scales">>=
