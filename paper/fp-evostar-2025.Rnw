...
Competitividad (Spanish Ministry of Competitivity and Economy) under project PID2023-147409NB-C22. We are also very grateful to the {\sf zig} community. Source and data available from \url{https://github.com/JJ/energy-bbob} under a GPL license.
