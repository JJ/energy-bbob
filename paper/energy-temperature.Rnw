...
<<europar25.pkg.var, echo=FALSE, message=F, fig.height=4, fig.show="hold", out.width="32%", fig.cap="PKG energy consumed vs. accumulated time; colors represent variable type and shape the chromosome size">>=
bbob.variable$size <- as.factor(bbob.variable$size)
library(ggplot2)
