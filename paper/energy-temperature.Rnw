...
ggplot(bbob.variable[ bbob.variable$work == "sharp_ridge",], aes(x=cumulative_seconds, y=PKG,shape=size, group=type,color=type)) +
  geom_point( aes(color=type)) + scale_color_brewer(palette="Set1") +
  labs(title="Sharp ridge", y="PKG", x="Cumulative seconds")+theme(legend.position="none")
...
ggplot(bbob.fixed[ bbob.fixed$work == "sharp_ridge",], aes(x=cumulative_seconds, y=PKG,shape=size, group=type,color=type)) +
  geom_point( aes(color=type)) + scale_color_brewer(palette="Set1") +
  labs(title="Sharp ridge", y="PKG", x="Cumulative seconds")+theme(legend.position="none")
@
